...
public class TypingRace
{
    ...
    public void startRace()
    {
        ...
        if (raceFinishedBy(seat1Typist)) {
            System.out.println(seat1Typist.getName() + " wins!");
            System.out.println("Final accuracy is : " + seat1Typist.getAccuracy() + " (improved from " + seat1Typist.getAccuracy() + ")");
        }
        if (raceFinishedBy(seat2Typist)) {
            System.out.println(seat2Typist.getName() + " wins!");
            System.out.println("Final accuracy is : " + seat1Typist.getAccuracy() + " (improved from " + seat2Typist.getAccuracy() + ")");
        }
        if (raceFinishedBy(seat3Typist)) {
            System.out.println(seat3Typist.getName() + " wins!");
            System.out.println("Final accuracy is : " + seat1Typist.getAccuracy() + " (improved from " + seat3Typist.getAccuracy() + ")");
        }
    }
    ...
    private boolean raceFinishedBy(Typist theTypist)
    {
        ...
        if (theTypist.getProgress() == passageLength | theTypist.getProgress() >= passageLength)
        {
            return true;
        }
        else
    ...
    public static void main (String[] args) {
        TypingRace race = new TypingRace(5);

        race.addTypist(new Typist ('1', "bob", 0.8), 1);
        race.addTypist(new Typist ('2', "rob", 0.1), 2);
        race.addTypist(new Typist ('3', "third", 0.9), 3);
        race.startRace();
    }
}
